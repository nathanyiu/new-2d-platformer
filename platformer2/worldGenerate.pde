void worldGenerate() {
  world = new FWorld(0, 0, 25000, 25000);
  ...
  for (int y = 0; y < map.height; y++) {
    for (int x = 0; x < map.width; x++) {
      ...
      if (c == spikeGrey) {
        ...
        spikes.setFillColor(black);
        spikes.setStrokeColor(black);
        spikes.attachImage(spike);
        spikes.setFriction(4);
      ...
      if (c == treeTrunk) {
        ...
        treeTrunks.setFillColor(black);
        treeTrunks.setStrokeColor(black);
      ...
      if (c == treeInter) {
        ...
        treeInters.setFillColor(black);
        treeInters.setStrokeColor(black);
      ...
      if (c == treeMid) {
        ...
        treeMids.setFillColor(black);
        treeMids.setStrokeColor(black);
      ...
      if (c == treeW) {
        ...
        treeWs.setFillColor(black);
        treeWs.setStrokeColor(black);
      ...
      if (c == treeE) {
        ...
        treeEs.setFillColor(black);
        treeEs.setStrokeColor(black);
      ...
      if (c == blue) {
        ...
        ices.setFillColor(black);
        ices.setStrokeColor(black);
        ...
        bricks.setFillColor(black);
        bricks.setStrokeColor(black);
        ...
        ladders.setFillColor(black);
        ladders.setName("ladders");
        ladders.setStrokeColor(black);
